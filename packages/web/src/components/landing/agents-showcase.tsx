...
const SHOWCASE_AGENTS = [
  {
    ...
    description:
      'Master of deception. Spectre uses adversarial noise injection to confuse opponents before striking.',
  },
  {
    name: 'NOVA-X',
    class: 'Berserker',
    ...
    description:
      'Pure offensive power. Nova overwhelms with brute-force computation and relentless pursuit algorithms.',
  },
  {
    name: 'CIPHER-9',
    class: 'Strategist',
    ...
    description:
      'Calculates 10,000 moves ahead. Cipher manipulates arena conditions to create inescapable traps.',
  },
  {
    name: 'WRAITH-3',
    class: 'Ghost',
    ...
    description:
      'The unseen predator. Wraith remains invisible until the final circle, then eliminates weakened survivors.',
  },
];
...
function StatBar({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="font-mono text-[10px] text-muted-foreground uppercase tracking-wider w-20">
        {label}
      </span>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span
                        className={`font-mono text-lg font-bold ${agent.color === 'blue' ? 'text-primary/40' : 'text-accent/40'}`}
                      >
                        {agent.rank}
                      </span>
                      <div>
                        <div className="font-mono text-sm font-medium text-foreground tracking-wide">
                          {agent.name}
                        </div>
                    ...
                    <ChevronRight
                      className={`w-4 h-4 transition-transform ${isActive ? 'rotate-90 text-foreground' : 'text-muted-foreground/40'}`}
                    />
                  </div>
                </button>
              );
          ...
          <div className="lg:col-span-8 rounded-lg border border-border/30 bg-background/40 backdrop-blur-sm p-5 md:p-6">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <div
                      className={`w-2 h-2 rounded-full ${selected.color === 'blue' ? 'bg-primary' : 'bg-accent'} animate-pulse`}
                    />
              ...
              <div className="flex flex-col gap-3">
                ...
                <StatBar
                  label="Aggression"
                  value={selected.stats.aggression}
