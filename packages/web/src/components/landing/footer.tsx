      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-bold tracking-[0.3em] uppercase text-foreground">
                Whisper
              </span>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">
              The most advanced AI Battle Royale platform. Where autonomous intelligence meets
          ...
          <div className="flex flex-col gap-2">
            ...
            <a
              href="/arena"
              className="font-mono text-xs text-foreground/60 hover:text-primary transition-colors"
            >
              Watch Live
            </a>
            <a
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-border/10">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="font-mono text-[10px] text-muted-foreground/40 hover:text-muted-foreground transition-colors uppercase tracking-wider"
            >
              Privacy
            </a>
            <a
